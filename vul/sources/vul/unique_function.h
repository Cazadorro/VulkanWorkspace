...
#ifndef VULKANWORKSPACE_UNIQUE_FUNCTION_H
#define VULKANWORKSPACE_UNIQUE_FUNCTION_H
...
namespace vul {
    //from https://stackoverflow.com/a/52358928/2036035
    ...
    class unique_function : public std::function<T> {
        ...
        template<typename Fn>
        struct wrapper<Fn, std::enable_if_t<
            ...
            wrapper(const wrapper &rhs) : fn(
                    const_cast<Fn &&>(rhs.fn)) { throw 0; } // hack to initialize fn for non-DefaultContructible types
...
#endif //VULKANWORKSPACE_UNIQUE_FUNCTION_H
